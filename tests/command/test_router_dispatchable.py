...
class TestIsDispatchableCommand:
    ...
    def test_exact_commands_match(self, router: CommandRouter) -> None:
        ...
        assert router.is_dispatchable_command("/dream_prompt")
    ...
    def test_prefix_commands_match(self, router: CommandRouter) -> None:
        assert router.is_dispatchable_command("/dream_log abc123")
        assert router.is_dispatchable_command("/dream_restore def456")
        assert router.is_dispatchable_command("/dream_prompt init")
